...
import org.Controladores.SemestreController;
 ...
 * @author F
 */
public class RepositorioProyectosFiltros extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(tipo.equals("semestres")){
            ArrayList<Semestre> semestres = new SemestreController().getSemestres();
            json = new Gson().toJson(semestres);
